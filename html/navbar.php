...
<header class="navbar navbar-expand-md d-print-none">
        <div class="container-xl">
          ...
          <div class="nav-item dropdown">
            ...
            <form action="/vservesafe_dev/shecup.php" method="post" id="myForm" style="margin-bottom:0px;padding-right:15px;">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(./static/avatars/<?php echo $_SESSION['profile_avatar'];?>)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div class="crop"><?php echo $_SESSION['profile_firstname']." ".$_SESSION['profile_lastname'];?></div>
                  <div class="mt-1 small text-secondary"><?php echo $_SESSION['user_role'];?></div>
                </div>
              </a>
